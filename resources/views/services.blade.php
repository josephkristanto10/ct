  ...
  and (max-width: 480px) { 
	...
	#penyangga_tanya_admin{
	   ...
	   <link rel="icon" type="image/x-icon" href="{{ asset('css/images/logo_amp.png') }}">
		...
		<meta name="keywords" content="Forklift berkualitas,Forklift Surabaya, Forklift Jakarta, Forklift Bandung,PT. Aneka Mesin Prima,aneka mesin prima,Forklift 3 Ton, Forklift 1.5 Ton, Forklift 2 Ton, Forkflift 2.5 Ton, Forklift 7 Ton, Forklift 10 Ton">

              ...
              if (mysqli_num_rows($query) > 0) {
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      ?>
                            ...
                            <br></br>
                            <a>Selamat Datang Peserta Tes : <span
                                    style="background-color: #FFFF00 ;"><b><?php echo $data['nama'] ?></b></a></span>
                            <p><a>Peserta Melamar Sebagai : <span
                                        style="background-color: #FFFF00 ;"><b><?php echo $data['posisi'] ?><b> -
                                                <?php echo $data['leveltes'] ?></b></a></span></p>
                            <?php
                  } 
              } else {
...
?>
        ...
        ?>
                                    ...
                                    <?php if($data['leveltes'] == "SEDANG" || $data['leveltes'] != "BIASA"){?>
                                    <tr>
                                        <th scope="row">4</th>
